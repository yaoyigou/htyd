(function(a)
{
    ...
    a(document).ready(function(){
        ...
        a('#fixed-suggestions>li').live('click',function(){
            ...
            location.href='/category?keywords='+a('#fixed-suggest').val()+'&showi=0'
        });
        ...
        function e(h){
            ...
            if(c==''||h.which==27){
                a('#fixed-suggestions').empty();a('#fixed-suggestions_wrap').hide()
            };
            if((h.which>=65&&h.which<=90)||h.which==8||h.which==46||h.which==32||h.which==13||h.which==undefined){
                b=0;
                if(d)d.abort();
        ...
        function g(h){
            switch(h.which){
                case 38:
                    ...
                    if(b==0){
                        i=c;a("#fixed-suggestions li").removeClass("active")
                    }else{
                ...
                case 13:
                    ...
                    location.href='/category?keywords='+a('#fixed-suggest').val()+'&showi=0';break
            }
        }
    })
})(jQuery);
