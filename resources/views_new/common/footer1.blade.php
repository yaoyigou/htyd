...
<div class="site-footer" style="margin-bottom: 20px;border-top: 1px solid #ebebeb;position: relative;">
    ...
    <ul class="secondul" style="width: 1200px;margin: 0 auto;position: relative;">
        ...
        <div class="erweimabottom" style="margin-top: 30px;border-left: 1px solid #e5e5e5;display: inline-block;margin-left:50px;">
    ...
    <div class="dibu" style="width: 1200px;margin:10px auto;*margin-top: 50px;">
        <p>互联网药品交易服务资格证：<a href="http://www.hezongyy.com/images/zgz1.jpg" target="_blank" style="color: #323333">川B20130002</a> | 互联网药品信息服务资格证：<a href="http://www.hezongyy.com/images/zgz2.jpg" target="_blank" style="color: #323333">川20150030</a></p>
    ...
    <div class="quick_link_mian">
        ...
        <div class="quick_links_panel">
            <div id="quick_links" class="quick_links">
                ...
                <li id="shopCart">
                    <a href="javascript:;" class="mpbtn_wdsc2">
                        <img src="{{get_img_path('images/new/fixed-gwc.png')}}" alt="" />
                        <div class="cart_number">{{cart_info()}}</div>
                    </a>
                </li>
                <li>
...
<script type="text/javascript" src="{{path('new/js/prettify.js')}}"></script>
