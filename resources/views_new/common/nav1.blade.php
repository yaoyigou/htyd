    ...
    <div class="site-content container">
        <div class="category-menu fn_clear" style="margin-top: -13px;">
            <ul class="category-list">
                <li class="child-li jiyao li1">
                    <p>
                        ...
                        <a href="{{route('category.index',['ylfl'=>'b'])}}">
                ...
                <li class="child-li li2">
                    <p>
                        ...
                        <a href="{{route('category.index',['ylfl'=>'c'])}}">
											<span class="title_text">
												清热、消炎
											</span>
                        </a>
                ...
                <li class="child-li jiyao li3">
                    <p><img src="{{path('new/images/left03.png')}}" class="leftimg"/>
                        ...
                        <a href="{{route('category.index',['ylfl'=>'d'])}}"><span class="title_text">五官、皮肤及外用</span></a>
                ...
                <li class="child-li li4">
                    <p><img src="{{path('new/images/left04.png')}}" class="leftimg"/>
                        ...
                        <a href="{{route('category.index',['ylfl'=>'e'])}}"><span class="title_text">消化、肝胆系统</span></a>
                        <img src="{{path('new/images/jiantou-right.png')}}" class="img-jiantou"/></p>
                </li>
                <li class="child-li li5">
                    <p><img src="{{path('new/images/left05.png')}}" class="leftimg"/>
                        ...
                        <a href="{{route('category.index',['ylfl'=>'f'])}}"><span class="title_text">补益安神及维矿类</span></a>
                        <img src="{{path('new/images/jiantou-right.png')}}" class="img-jiantou"/></p>
                </li>
                <li class="child-li li6">
                    <p><img src="{{path('new/images/left06.png')}}" class="leftimg"/>
                        ...
                        <a href="{{route('category.index',['ylfl'=>'g'])}}"><span class="title_text">妇、儿科</span></a>
                        <img src="{{path('new/images/jiantou-right.png')}}" class="img-jiantou"/>
                    </p>
                </li>
                <li class="child-li li7">
                    <p><img src="{{path('new/images/left07.png')}}" class="leftimg"/>
                        ...
                        <a href="{{route('category.index',['ylfl'=>'h'])}}"><span
                ...
                <li class="child-li li8">
                    <p><img src="{{path('new/images/left08.png')}}" class="leftimg"/>
                        ...
                        <a href="{{route('category.index',['ylfl'=>'i'])}}"><span
                ...
                <li class="child-li li9">
                    <p><img src="{{path('new/images/left09.png')}}" class="leftimg"/>
                        ...
                        <a href="{{route('category.index',['ylfl'=>'j'])}}"><span
                                    class="title_text">风湿骨伤及其它药品</span></a>
                        <img src="{{path('new/images/jiantou-right.png')}}" class="img-jiantou"/>
                    </p>
                </li>
                <li class="child-li li10">
                    <p><img src="{{path('new/images/left10.png')}}" class="leftimg"/>
                        ...
                        <a href="{{route('category.index',['ylfl'=>'k'])}}"><span
                ...
                <li class="child-li li12">
                    <p><img src="{{path('new/images/left12.png')}}" class="leftimg"/>
                        ...
                        <a href="{{route('category.index',['ylfl'=>'m'])}}"><span class="title_text">非药品</span></a>
                        <img src="{{path('new/images/jiantou-right.png')}}" class="img-jiantou"/>
                    </p>
                </li>
            </ul>
            ...
            <ul class="category-list-child fn_clear" style="padding-bottom: 30px">
                <li style="ylflplay: none;" class="jiyao fn_clear right-box-1">
                        ...
                        <div @if($k==0) class="xiyao-box" @else class="zhongyao-box" @endif>
                            ...
                            <div class="fn_clear content-xiyao">
                                @foreach($cat1->cate as $cat2)
                                    <a href="{{route('category.index',['ylfl'=>'b','ylfl1'=>$cat2->cat_id])}}"
                                       target="_blank"
                ...
                <li class="jiyao fn_clear right-box-2">
                    @foreach($cate_tree->where('cat_id','496')->first()->cate as $k=>$cat1)
                        ...
                        <div @if($k==0) class="xiyao-box" @else class="zhongyao-box" @endif>
                            ...
                            <div class="fn_clear content-xiyao">
                                @foreach($cat1->cate as $cat2)
                                    <a href="{{route('category.index',['ylfl'=>'c','ylfl1'=>$cat2->cat_id])}}"
                                       target="_blank"
                                       title="{{$cat2->cat_name}}">{{$cat2->cat_name}}</a>
                                @endforeach
                            </div>
                ...
                <li class="jiyao fn_clear right-box-3">
                    @foreach($cate_tree->where('cat_id','531')->first()->cate as $k=>$cat1)
                        ...
                        <div @if($k==0) class="xiyao-box" @else class="zhongyao-box" @endif>
                            ...
                            <div class="fn_clear content-xiyao">
                                @foreach($cat1->cate as $cat2)
                                    <a href="{{route('category.index',['ylfl'=>'d','ylfl1'=>531,'ylfl2'=>$cat2->cat_id])}}"
                                       target="_blank"
                                       title="{{$cat2->cat_name}}">{{$cat2->cat_name}}</a>
                                @endforeach
                            </div>
                    ...
                    @foreach($cate_tree->where('cat_id','548')->first()->cate as $k=>$cat1)
                        ...
                        <div @if($k==0) class="xiyao-box" @else class="zhongyao-box" @endif>
                            ...
                            <div class="fn_clear content-xiyao">
                                @foreach($cat1->cate as $cat2)
                                    <a href="{{route('category.index',['ylfl'=>'d','ylfl1'=>538,'ylfl2'=>$cat2->cat_id])}}"
                                       target="_blank"
                                       title="{{$cat2->cat_name}}">{{$cat2->cat_name}}</a>
                                @endforeach
                            </div>
                ...
                <li class="fn_clear right-box-4">
                    @foreach($cate_tree->where('cat_id','575')->first()->cate as $k=>$cat1)
                        ...
                        <div @if($k==0) class="xiyao-box" @else class="zhongyao-box" @endif>
                            ...
                            <div class="fn_clear content-xiyao">
                                @foreach($cat1->cate as $cat2)
                                    <a href="{{route('category.index',['ylfl'=>'e','ylfl1'=>$cat2->cat_id])}}"
                                       target="_blank"
                                       title="{{$cat2->cat_name}}">{{$cat2->cat_name}}</a>
                                @endforeach
                            </div>
                ...
                <li class="fn_clear right-box-5">
                    @foreach($cate_tree->where('cat_id','620')->first()->cate as $k=>$cat1)
                        ...
                        <div @if($k==0) class="xiyao-box" @else class="zhongyao-box" @endif>
                            ...
                            <div class="fn_clear content-xiyao">
                                @foreach($cat1->cate as $cat2)
                                    <a href="{{route('category.index',['ylfl'=>'f','ylfl1'=>$cat2->cat_id])}}"
                                       target="_blank"
                                       title="{{$cat2->cat_name}}">{{$cat2->cat_name}}</a>
                                @endforeach
                            </div>
                ...
                <li class="fn_clear right-box-6">
                    @foreach($cate_tree->where('cat_id','536')->first()->cate as $k=>$cat1)
                        ...
                        <div @if($k==0) class="xiyao-box" @else class="zhongyao-box" @endif>
                            ...
                            <div class="fn_clear content-xiyao">
                                @foreach($cat1->cate as $cat2)
                                    <a href="{{route('category.index',['ylfl'=>'g','ylfl1'=>536,'ylfl2'=>$cat2->cat_id])}}"
                                       target="_blank"
                                       title="{{$cat2->cat_name}}">{{$cat2->cat_name}}</a>
                                @endforeach
                            </div>
                    ...
                    @foreach($cate_tree->where('cat_id','584')->first()->cate as $k=>$cat1)
                        ...
                        <div @if($k==0) class="xiyao-box" @else class="zhongyao-box" @endif>
                            ...
                            <div class="fn_clear content-xiyao">
                                @foreach($cat1->cate as $cat2)
                                    <a href="{{route('category.index',['ylfl'=>'g','ylfl1'=>584,'ylfl2'=>$cat2->cat_id])}}"
                                       target="_blank"
                                       title="{{$cat2->cat_name}}">{{$cat2->cat_name}}</a>
                                @endforeach
                            </div>
                ...
                <li class="fn_clear right-box-7">
                    @foreach($cate_tree->where('cat_id','619')->first()->cate as $k=>$cat1)
                        ...
                        <div @if($k==0) class="xiyao-box" @else class="zhongyao-box" @endif>
                            ...
                            <div class="fn_clear content-xiyao">
                                @foreach($cat1->cate as $cat2)
                                    <a href="{{route('category.index',['ylfl'=>'h','ylfl1'=>619,'ylfl2'=>$cat2->cat_id])}}"
                                       target="_blank"
                                       title="{{$cat2->cat_name}}">{{$cat2->cat_name}}</a>
                                @endforeach
                            </div>
                    ...
                    @foreach($cate_tree->where('cat_id','767')->first()->cate as $k=>$cat1)
                        ...
                        <div @if($k==0) class="xiyao-box" @else class="zhongyao-box" @endif>
                            ...
                            <div class="fn_clear content-xiyao">
                                @foreach($cat1->cate as $cat2)
                                    <a href="{{route('category.index',['ylfl'=>'h','ylfl1'=>767,'ylfl2'=>$cat2->cat_id])}}"
                                       target="_blank"
                                       title="{{$cat2->cat_name}}">{{$cat2->cat_name}}</a>
                                @endforeach
                            </div>
                ...
                <li style="" class="jiyao fn_clear right-box-8">
                    @foreach($cate_tree->where('cat_id','788')->first()->cate as $k=>$cat1)
                        ...
                        <div @if($k==0) class="xiyao-box" @else class="zhongyao-box" @endif>
                            ...
                            <div class="fn_clear content-xiyao">
                                @foreach($cat1->cate as $cat2)
                                    <a href="{{route('category.index',['ylfl'=>'i','ylfl1'=>788,'ylfl2'=>$cat2->cat_id])}}"
                                       target="_blank"
                                       title="{{$cat2->cat_name}}">{{$cat2->cat_name}}</a>
                                @endforeach
                            </div>
                    ...
                    @foreach($cate_tree->where('cat_id','778')->first()->cate as $k=>$cat1)
                        ...
                        <div @if($k==0) class="xiyao-box" @else class="zhongyao-box" @endif>
                            ...
                            <div class="fn_clear content-xiyao">
                                @foreach($cat1->cate as $cat2)
                                    <a href="{{route('category.index',['ylfl'=>'i','ylfl1'=>778,'ylfl2'=>$cat2->cat_id])}}"
                                       target="_blank"
                                       title="{{$cat2->cat_name}}">{{$cat2->cat_name}}</a>
                                @endforeach
                            </div>
                    ...
                    @foreach($cate_tree->where('cat_id','796')->first()->cate as $k=>$cat1)
                        ...
                        <div @if($k==0) class="xiyao-box" @else class="zhongyao-box" @endif>
                            ...
                            <div class="fn_clear content-xiyao">
                                @foreach($cat1->cate as $cat2)
                                    <a href="{{route('category.index',['ylfl'=>'i','ylfl1'=>796,'ylfl2'=>$cat2->cat_id])}}"
                                       target="_blank"
                                       title="{{$cat2->cat_name}}">{{$cat2->cat_name}}</a>
                                @endforeach
                            </div>
                ...
                <li style="ylflplay: none;" class="jiyao fn_clear right-box-9">
                    @foreach($cate_tree->where('cat_id','801')->first()->cate as $k=>$cat1)
                        ...
                        <div @if($k==0) class="xiyao-box" @else class="zhongyao-box" @endif>
                            ...
                            <div class="fn_clear content-xiyao">
                                @foreach($cat1->cate as $cat2)
                                    <a href="{{route('category.index',['ylfl'=>'j','ylfl1'=>801,'ylfl2'=>$cat2->cat_id])}}"
                                       target="_blank"
                                       title="{{$cat2->cat_name}}">{{$cat2->cat_name}}</a>
                                @endforeach
                            </div>
                    ...
                    @foreach($cate_tree->where('cat_id','655')->first()->cate as $k=>$cat1)
                        ...
                        <div @if($k==0) class="xiyao-box" @else class="zhongyao-box" @endif>
                            ...
                            <div class="fn_clear content-xiyao">
                                @foreach($cat1->cate as $cat2)
                                    <a href="{{route('category.index',['ylfl'=>'j','ylfl1'=>655,'ylfl2'=>$cat2->cat_id])}}"
                                       target="_blank"
                                       title="{{$cat2->cat_name}}">{{$cat2->cat_name}}</a>
                                @endforeach
                            </div>
                    ...
                    @foreach($cate_tree->where('cat_id','665')->first()->cate as $k=>$cat1)
                        ...
                        <div @if($k==0) class="xiyao-box" @else class="zhongyao-box" @endif>
                            ...
                            <div class="fn_clear content-xiyao">
                                @foreach($cat1->cate as $cat2)
                                    <a href="{{route('category.index',['ylfl'=>'j','ylfl1'=>665,'ylfl2'=>$cat2->cat_id])}}"
                                       target="_blank"
                                       title="{{$cat2->cat_name}}">{{$cat2->cat_name}}</a>
                                @endforeach
                            </div>
                ...
                <li style="ylflplay: none;" class="jiyao fn_clear right-box-10">
                    @foreach($cate_tree->where('cat_id','674')->first()->cate as $k=>$cat1)
                        ...
                        <div @if($k==0) class="xiyao-box" @else class="zhongyao-box" @endif>
                            ...
                            <div class="fn_clear content-xiyao">
                                @foreach($cat1->cate as $cat2)
                                    <a href="{{route('category.index',['ylfl'=>'k','ylfl1'=>$cat2->cat_id])}}"
                                       target="_blank"
                                       title="{{$cat2->cat_name}}">{{$cat2->cat_name}}</a>
                                @endforeach
                            </div>
                    ...
                    <div class="xiyao-box">
                        ...
                        <div class="fn_clear content-xiyao">
                            @foreach($cate_tree->where('cat_id','682')->first()->cate as $cat2)
                                <a href="{{route('category.index',['ylfl'=>'k','ylfl1'=>682,'ylfl2'=>$cat2->cat_id])}}"
                                   target="_blank"
                                   title="{{$cat2->cat_name}}">{{$cat2->cat_name}}</a>
                            @endforeach
                        </div>
                ...
                <li style="ylflplay: none;" class="jiyao fn_clear right-box-11">
                    <p>{{$cate_tree->where('cat_id','445')->first()->cat_name}}</p>
                    <div class="xiyao-box">
                        <div class="Notitle"></div>
                        <div class="fn_clear content-xiyao">
                            @foreach($cate_tree->where('cat_id','445')->first()->cate as $cat2)
                                <a href="{{route('category.zyyp',['pid'=>$cat2->cat_id])}}"
                                   target="_blank"
                                   title="{{$cat2->cat_name}}">{{$cat2->cat_name}}</a>
                            @endforeach
                        </div>
                ...
                <li style="ylflplay: none;" class="jiyao fn_clear right-box-12">
                    <p>{{$cate_tree->where('cat_id','683')->first()->cat_name}}</p>
                    <div class="xiyao-box">
                        <div class="Notitle"></div>
                        <div class="fn_clear content-xiyao">
                            @foreach($cate_tree->where('cat_id','683')->first()->cate as $cat2)
                                <a href="{{route('category.index',['ylfl'=>'m','ylfl1'=>683,'ylfl2'=>$cat2->cat_id])}}"
                                   target="_blank"
                                   title="{{$cat2->cat_name}}">{{$cat2->cat_name}}</a>
                            @endforeach
                        </div>
                    ...
                    <div class="xiyao-box">
                        ...
                        <div class="fn_clear content-xiyao">
                            @foreach($cate_tree->where('cat_id','12')->first()->cate as $cat2)
                                <a href="{{route('category.index',['ylfl'=>'m','ylfl1'=>12,'ylfl2'=>$cat2->cat_id])}}"
                                   target="_blank"
                                   title="{{$cat2->cat_name}}">{{$cat2->cat_name}}</a>
                            @endforeach
                        </div>
                    ...
                    <div class="xiyao-box">
                        ...
                        <div class="fn_clear content-xiyao">
                            @foreach($cate_tree->where('cat_id','732')->first()->cate as $cat2)
                                <a href="{{route('category.index',['ylfl'=>'m','ylfl1'=>732,'ylfl2'=>$cat2->cat_id])}}"
                                   target="_blank"
                                   title="{{$cat2->cat_name}}">{{$cat2->cat_name}}</a>
                            @endforeach
                        </div>
                    ...
                    <div class="xiyao-box">
                        ...
                        <div class="fn_clear content-xiyao">
                            @foreach($cate_tree->where('cat_id','739')->first()->cate as $cat2)
                                <a href="{{route('category.index',['ylfl'=>'m','ylfl1'=>739,'ylfl2'=>$cat2->cat_id])}}"
                                   target="_blank"
                                   title="{{$cat2->cat_name}}">{{$cat2->cat_name}}</a>
                            @endforeach
                        </div>
                    ...
                    <div class="xiyao-box">
                        ...
                        <div class="fn_clear content-xiyao">
                            @foreach($cate_tree->where('cat_id','751')->first()->cate as $cat2)
                                <a href="{{route('category.index',['ylfl'=>'m','ylfl1'=>751,'ylfl2'=>$cat2->cat_id])}}"
                                   target="_blank"
                                   title="{{$cat2->cat_name}}">{{$cat2->cat_name}}</a>
                            @endforeach
                        </div>
                    ...
                    <div class="xiyao-box">
                        ...
                        <div class="fn_clear content-xiyao">
                            @foreach($cate_tree->where('cat_id','899')->first()->cate as $cat2)
                                <a href="{{route('category.index',['ylfl'=>'m','ylfl1'=>899,'ylfl2'=>$cat2->cat_id])}}"
                                   target="_blank"
                                   title="{{$cat2->cat_name}}">{{$cat2->cat_name}}</a>
                            @endforeach
                        </div>
                    ...
                    <div class="xiyao-box">
                        ...
                        <div class="fn_clear content-xiyao">
                            @foreach($cate_tree->where('cat_id','922')->first()->cate as $cat2)
                                <a href="{{route('category.index',['ylfl'=>'m','ylfl1'=>922,'ylfl2'=>$cat2->cat_id])}}"
                                   target="_blank"
                                   title="{{$cat2->cat_name}}">{{$cat2->cat_name}}</a>
                            @endforeach
                        </div>
