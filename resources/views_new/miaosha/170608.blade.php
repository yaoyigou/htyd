...
@section('links')
    <style>
        ...
        #miaosha-top {
            ...
            height: 420px;
            min-width: 1200px;
            background: url('{{get_img_path('images/miaosha/miaosha-top.jpg')}}') no-repeat scroll top center;
        }
        ...
        #miaosha-bottom {
            ...
            height: 980px;
            min-width: 1200px;
            background: url('{{get_img_path('images/miaosha/miaosha-bottom.jpg')}}') no-repeat scroll top center;
        }
    ...
    <div id="miaosha-bottom">
        <div class="chanpin-box">
            @foreach($team[0]->goods as $k=>$v)
                <div class="ct-{{$k+1}}"
                     style="background: url('{{get_img_path('images/miaosha/68-'.$v->goods_id.'.jpg')}}') no-repeat scroll top center;">
                    <div class="kucun">
                    ...
                    <img @if($v->goods_number<=0) style="display: block;"
                         @endif src="{{get_img_path('images/miaosha/maiwan.png')}}" class="maiwan"/>
                </div>
            @endforeach
            <div class="68-bot" style="margin: 20px auto;width: 920px;height: 266px;">
                <img src="{{get_img_path('images/miaosha/68-bottom.png')}}"/>
            </div>
        </div>
