...
@section('links')
    <style>
        ...
        #miaosha-top {
            width: 100%;
            height: 420px;
            background: url('{{get_img_path('images/miaosha/170621/pcmiaosha-1.jpg')}}') no-repeat scroll top center;
            min-width: 1200px;
        }
        ...
        #miaosha-bottom {
            width: 100%;
            height: 460px;
            background: url('{{get_img_path('images/miaosha/170621/pcmiaosha-2.jpg')}}') no-repeat scroll top center;
            /*background: #1cb0ea;*/
            min-width: 1200px;
        }
        ...
        .ct-2 {
            background: url('{{get_img_path('images/miaosha/170621/pc-2.jpg')}}') no-repeat scroll top center;
            margin-left: 20px;
        }
    ...
    <div id="miaosha-bottom">
        <div class="chanpin-box">
            @foreach($team[0]->goods as $k=>$v)
                <div class="ct-{{$k+1}}"
                     style="background: url('{{get_img_path('images/miaosha/170621/pc-'.$v->goods_id.'.jpg')}}') no-repeat scroll top center;">
                    <div class="kucun">
            ...
            @endforeach
            <div class="bottom" style="width: 100%;height:94px;background: #1cb0ea;">
