...
<head>
    ...
    <style type="text/css">
        .time-item{width:560px;height: 100px;margin:75px 0 0 462px;}
...
<div id="top" style='background: url("{{get_img_path('images/shuang11-zht055.jpg')}}") no-repeat scroll center top;height: 362px;min-width: 1200px;overflow: hidden;width: 100%;'>
</div>
<div style='background: url("{{get_img_path('images/shuang11-zht056.jpg')}}") no-repeat scroll center top;height: 238px;min-width: 1200px;overflow: hidden;width: 100%;'>
    <div class="js-box" style="width:1200px;height:238px;margin:0 auto;position:relative;">
...
<div  style='background: url("{{get_img_path('images/shuang11-zht057.jpg')}}") no-repeat scroll center top;height: 275px;min-width: 1200px;overflow: hidden;width: 100%;'>
    <div style="width:1200px;margin:0 auto;">
        <a target="_blank" href="{{route('cj.bm')}}" style="width:360px;height:180px;display:block;float:left;margin:65px 27px 0 30px;"></a>
        <a target="_blank" href="{{route('cj.jfdh')}}" style="width:360px;height:180px;display:block;float:left;margin:65px 27px 0 0px;"></a>
        <a target="_blank" href="{{route('cj.cj')}}" style="width:360px;height:180px;display:block;float:left;margin:65px 27px 0 0px;"></a>
    </div>
